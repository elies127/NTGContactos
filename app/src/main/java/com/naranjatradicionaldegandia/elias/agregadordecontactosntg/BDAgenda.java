...
public class BDAgenda extends SQLiteOpenHelper {
    ...
    private static final String TABLA_NOTAS =
            "CREATE TABLE contactos " +
                    ...
                    " mail VARCHAR(100), npedidos INTEGER(1000));";
    ...
    public void insertarContacto(String nombre, String direccion, String movil, String mail, int npedidos) {
    ...
    public void modificarContacto(int id, String nombre, String direccion,String movil,String mail, int npedidos){
    ...
    public Contacto recuperarContacto(int id) {
        ...
        String[] valores_recuperar = {"_id", "nombre", "direccion", "movil", "mail", "npedidos"};
    ...
    public Cursor busquedaContacto(String nombre) {
        ...
        if(nombre.length() > 0){
            ...
            String[] valores_recuperar = {"_id","movil","nombre", "npedidos"};
