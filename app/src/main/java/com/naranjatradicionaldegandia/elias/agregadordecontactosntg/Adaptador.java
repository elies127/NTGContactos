...
public class Adaptador extends CursorAdapter{
    ...
    TextView nombre, movil, npedidos;
    ImageView imagen;
    ...
    public void bindView(View vista, Context contexto, Cursor c) {
        ...
        npedidos = (TextView) vista.findViewById(R.id.d_list_npedidos);
        ...
        npedidos.setText(c.getString(c.getColumnIndex("npedidos")));
        //imagen.setImageBitmap(recogerImagen(c.getString(c.getColumnIndex("nombre"))+".png")); Descomentar si se desea implementar la parte de la imagen
    }
